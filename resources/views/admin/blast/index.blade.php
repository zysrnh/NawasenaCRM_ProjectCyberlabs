    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="blastForm()">
            ...
            <form method="POST" action="{{ route('admin.blast.send') }}">
                ...
                {{-- Grid 2 kolom, align-items: start supaya tiap kolom natural height --}}
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                            ...
                            <div class="p-3">
                                <div class="rounded-xl overflow-hidden border border-gray-200 shadow-sm">
                                    {{-- WA Header --}}
                                    <div class="px-3 py-2 flex items-center gap-3 shadow-sm" style="background-color: #075E54;">
                                    ...
                                    {{-- WA Chat Body --}}
                                    <div class="px-3 py-3" style="background-color: #ECE5DD; background-image: url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png'); min-height: 220px;">
                                        ...
                                        <div class="flex justify-end pb-2">
                                            <div class="relative rounded-xl rounded-tr-none shadow-sm max-w-[92%] px-3 py-2" style="background-color: #DCF8C6;">
                    ...
                    <div>
                        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                            ...
                            <div class="p-4 flex flex-col gap-3">
                                ...
                                {{-- Textarea — tinggi tetap, tidak shrink --}}
                                <div>
                                    <textarea id="pesan_wa" name="pesan" x-model="pesan"
                                        class="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm focus:border-gold focus:ring-1 focus:ring-gold bg-white transition-all duration-150 resize-y leading-relaxed placeholder-gray-400"
